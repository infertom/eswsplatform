 ...
 */
@WebServlet("/ChangeFirstQuota")
public class ChangeFirstQuota extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect("SuperAdminstrator/FirstQuotaManagement.jsp");
		} catch (Exception e) {
