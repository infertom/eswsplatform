 ...
 */
@WebServlet("/ChangeFinalResultToTrue")
public class ChangeFinalResultToTrue extends HttpServlet {
     ...
     */
    public ChangeFinalResultToTrue() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		adminService.changeFinalResult(id,true);
