 ...
 */
@WebServlet("/ChangePreResultToTrue")
public class ChangePreResultToTrue extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		adminService.changePreResult(id,true);
